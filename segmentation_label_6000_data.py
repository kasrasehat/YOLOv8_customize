...
for idx, file_name in enumerate(os.listdir('/home/kasra/PycharmProjects/YOLOv8_customize/extra_file1')):
    img = '/home/kasra/PycharmProjects/YOLOv8_customize/extra_file1' + '/' + file_name
